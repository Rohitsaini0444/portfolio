            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-4">
                  ...
                  <button className="flex-1 py-3 rounded-xl border border-slate-700 hover:border-cyan-400 transition-all duration-300 flex items-center justify-center gap-2">
                    <FaGithub /> GitHub
                  </button>
                </div>
              </div>
